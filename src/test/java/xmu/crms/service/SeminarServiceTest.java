...
public class SeminarServiceTest {
	...
	public void deleteSeminarByCourseId() {
		try {
			Boolean seminars = seminarService.deleteSeminarByCourseId(new BigInteger("1"));
			assertNotNull(seminars);

			seminars = seminarService.deleteSeminarByCourseId(new BigInteger("89"));
			seminars = seminarService.deleteSeminarByCourseId(null);
		} catch (IllegalArgumentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (CourseNotFoundException e) {
	...
	public void updateSeminarBySeminarId() {
		...
		try {
			...
			boolean flag = seminarService.updateSeminarBySeminarId(new BigInteger("1"), seminar);
			assertNotNull(flag);
			System.out.println(flag);
			flag = seminarService.updateSeminarBySeminarId(new BigInteger("89"), seminar);
			flag = seminarService.updateSeminarBySeminarId(null, seminar);
		} catch (IllegalArgumentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SeminarNotFoundException e) {
	...
	public void deleteSeminarBySeminarId() {
		...
		try {
			...
			boolean flag = seminarService.deleteSeminarBySeminarId(new BigInteger("1"));
			assertNotNull(flag);
			System.out.println(flag);
			flag = seminarService.deleteSeminarBySeminarId(new BigInteger("89"));
			flag = seminarService.deleteSeminarBySeminarId(null);
		} catch (IllegalArgumentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SeminarNotFoundException e) {
