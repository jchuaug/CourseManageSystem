...
public class UserController {
	...
	public LoginResponseVO register(@RequestBody RegisterRequestVO req) {
		...
		User user = loginService.signUpPhone(new User(req.getPhone(), MD5Utils.getMD5(req.getPassword()), req.getName(), req.getGender(),
				req.getType(), req.getNumber(), req.getEmail()));
