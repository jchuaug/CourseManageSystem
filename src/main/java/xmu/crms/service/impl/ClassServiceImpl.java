...
import xmu.crms.dao.ClassInfoDao;
...
public class ClassServiceImpl implements ClassService {
	...
	public List<ClassInfo> listClassByName(String courseName, String teacherName)
		...
		List<Course> listByTeachername = listCourseByTeacherNameAndCourseName(teacherName, courseName);
		for (Course course : listByTeachername) {
			list.addAll(listClassByCourseId(course.getId()));
		}
		return list;
	}
	...
	@Override
	public Integer getNumStudentByClassId(BigInteger id) {
		int numStudent = classInfoMapper.getNumStudentByClassId(id);
		return numStudent;
	}
	...
	public void endCallRollById(Location location) throws SeminarNotFoundException, ClassesNotFoundException {
		...
		int flag = classInfoMapper.updateLocation(location);
