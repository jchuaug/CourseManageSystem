...
public class GradeServiceImpl implements GradeService {
    ...
    public void countPresentationGrade(BigInteger seminarId) throws IllegalArgumentException {
        ...
        for (SeminarGroup seminarGroup : seminarGroups) {
            ...
            gradeMapper.updateSeminarGroupPresentationScore(seminarGroup.getId(), pTopicGrade);
        }
    }
    ...
    @Override
    public void insertGroupGradeByUserId(BigInteger studentId, BigInteger groupId, Integer score) {

        gradeMapper.insertGroupPresentationGradeByUserId(studentId, groupId, score);
    }
}
