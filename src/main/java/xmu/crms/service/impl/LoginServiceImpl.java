...
public class LoginServiceImpl implements LoginService {
	...
	public User signUpPhone(User user) {
		...
		try {
			...
			userResult = userMapper.getUserByUserId(loginMapper.signUpPhone(user.getPhone(), user.getPassword()));
			if (userResult == null) {
	...
	public void signUpWeChat(User user) throws IllegalArgumentException {
		...
		try {
			returnId = loginMapper.signUpWeChat(user.getPhone(), user.getPassword());
			if (returnId == null) {
